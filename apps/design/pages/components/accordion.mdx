...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@c14/design-system/components/ui/accordion";
...
<Cards className="mt-8">
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/GURLNa08cG0eTbioJtPwub/%F0%9F%92%BE-C14%2Fdesign-system?node-id=612-22584&t=jWCgbJWcyEzdpwjF-1"
  />
  <Card
    title="🐝 API Reference"
